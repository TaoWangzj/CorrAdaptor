...
class MS2DGBlock(nn.Module):
    def __init__(self, net_channels, input_channel, depth, clusters):
        ...
        self.conv11 = nn.Conv2d(channels, channels // 2, kernel_size=1)
...
class MS2DNET(nn.Module):
    def __init__(self):
        ...
        self.weights_init = MS2DGBlock(128, 4 + self.side_channel, depth_each_stage, 500)
        self.weights_iter = [MS2DGBlock(128, 6 + self.side_channel, depth_each_stage, 500)
                             for _ in range(1)]
